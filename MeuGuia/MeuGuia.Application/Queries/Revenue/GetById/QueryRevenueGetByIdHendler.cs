...
public class QueryRevenueGetByIdHendler : CreateBaseCommand, IRequestHandler<QueryRevenueGetByIdRequest, QueryRevenueGetByIdResponse>
{
    ...
    public QueryRevenueGetByIdHendler(INotificationError notificationError, IMapper iMapper, IRepositoryRevenue iRepositoryRevenue) : base(notificationError, iMapper)
    {
